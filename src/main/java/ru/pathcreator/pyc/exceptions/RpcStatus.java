...
/**
 * Built-in RPC status codes used by the transport and by shared service-level
 * validation failures.
 *
 ...
 * values {@code >= 1000}. That separation keeps service-specific errors from
 * colliding with library-defined failures.</p>
 */
